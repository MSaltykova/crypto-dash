...
function createLocation(current, to2, state = null, key, unstable_mask) {
  let location = {
...
function getUrlBasedHistory(getLocation, createHref2, validateLocation, options = {}) {
  ...
  function push(to2, state) {
    action = "PUSH";
    let location = isLocation(to2) ? to2 : createLocation(history.location, to2, state);
    index = getIndex() + 1;
...
const Header = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "top-nav", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "Home" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", children: "About" })
  ] });
};
const CoinCard = ({ coin }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/coin/${coin.id}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "coin-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "coin-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: coin.image, alt: coin.name, className: "coin-image" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: coin.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "symbol", children: coin.symbol.toUpperCase() })
      ] })
    ] }),
...
const LimitSelector = ({ limit, onLimitChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "controls", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "limit", children: "Show: " }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        value: limit,
...
const FilterInput = ({ filter, onFilterChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "filter", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "input",
    {
      type: "text",
      value: filter,
...
const SortSelector = ({ sortBy, onSortChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "controls", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "sort", children: "Sort By:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        id: "sort",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "market_cap_desc", children: "Market Cap (High To Low)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "market_cap_asc", children: "Market Cap (Low To High)" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "change_desc", children: "24h Change (High To Low)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "change_asc", children: "24h Change (Low To High)" })
        ]
      }
    )
  ] });
...
var handleRgbColorString = function(color2, opacity) {
  if (color2.includes("/")) {
    return color2.replace("rgb(", "rgba(");
  }
  var rgbValues = color2.substring(color2.startsWith("rgba(") ? 5 : 4, color2.length - 1).trim();
...
var calculateRgba = function(color2, opacity) {
  if (color2.startsWith("rgb")) {
    return handleRgbColorString(color2, opacity);
  }
  if (Object.keys(BasicColors).includes(color2)) {
    color2 = BasicColors[color2];
  }
  if (color2[0] === "#") {
  ...
  if (color2.length === 3) {
    var res_1 = "";
    color2.split("").forEach(function(c) {
      res_1 += c;
      res_1 += c;
    });
    color2 = res_1;
  }
  var rgbValues = (color2.match(/.{2}/g) || []).map(function(hex2) {
...
function BarLoader(_a2) {
  var _b = _a2.loading, loading = _b === void 0 ? true : _b, _c = _a2.color, color2 = _c === void 0 ? "#000000" : _c, _d = _a2.speedMultiplier, speedMultiplier = _d === void 0 ? 1 : _d, _e = _a2.cssOverride, cssOverride = _e === void 0 ? {} : _e, _f = _a2.height, height = _f === void 0 ? 4 : _f, _g = _a2.width, width = _g === void 0 ? 100 : _g, additionalprops = __rest(_a2, ["loading", "color", "speedMultiplier", "cssOverride", "height", "width"]);
  var wrapper = __assign({ display: "inherit", position: "relative", width: cssValue(width), height: cssValue(height), overflow: "hidden", backgroundColor: calculateRgba(color2, 0.2), backgroundClip: "padding-box" }, cssOverride);
...
const Spinner = ({ color: color2 = "blue", size = 150 }) => {
...
const HomePage = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "🚀 Crypto Dash" }),
    loading && /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { color: "white" }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error", children: error }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "top-controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterInput, { filter, onFilterChange: setFilter }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LimitSelector, { limit, onLimitChange: setLimit }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SortSelector, { sortBy, onSortChange: setSortBy })
    ] }),
    !loading && !error && /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "grid", children: filteredCoins.length > 0 ? filteredCoins.map((coin) => /* @__PURE__ */ jsxRuntimeExports.jsx(CoinCard, { coin }, coin.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No matching coins" }) })
  ] });
};
const AboutPage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Abour Crypto Dash" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Crypto Dash is a simple React application that displays live cryptocurrency data using the CoinGecko API." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "You can explore the top cryptocurrencies by market cap, filter by name or symbol, and sort them by price, market cap, or 24-hour change." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "This project is built as part of a React tutorial to help you understand hooks, components, state management, and integrating with external APIs." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "🚀 Future features might include detailed coin views, favorites, pagination, and much more!" })
  ] });
};
const NotFoundPage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.container, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.message, children: "Oops! The page you're looking for does not exist" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", style: styles.link, children: "← Go Back Home" })
  ] });
};
const styles = {
  container: {
...
const API_URL$2 = "https://api.coingecko.com/api/v3/coins/";
const CoinChart = ({ coinId }) => {
  ...
  reactExports.useEffect(() => {
    const fetchPrices = async () => {
      const res = await fetch(
        `${API_URL$2}/${coinId}/market_chart?vs_currency=usd&days=7`
      );
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading Chart..." });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "30px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Line,
    {
      data: chartData,
      options: {
...
const API_URL$1 = "https://api.coingecko.com/api/v3/coins/";
const CoinDetailsPage = () => {
  var _a2;
  const { id: id2 } = useParams();
  const [coin, setCoin] = reactExports.useState(null);
  const [loading, setLoading] = reactExports.useState(true);
  const [error, setError] = reactExports.useState(null);
  reactExports.useEffect(() => {
    const fetchCoin = async () => {
      try {
        const res = await fetch(`${API_URL$1}/${id2}`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "coin-details-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "← Back To Home" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "coin-details-title", children: coin ? `${coin.name} (${coin.symbol.toUpperCase()})` : "Coin Details" }),
    loading && /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}),
    error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "error", children: [
      "❌ ",
      error
    ] }),
    !loading && !error && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: coin.description.en.split(". ")[0] + "." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "coin-details-info", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { children: [
          "Total Supply:",
          " ",
          ((_a2 = coin.market_data.total_supply) == null ? void 0 : _a2.toLocaleString()) || "N/A"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { children: [
          "All-Time High: $",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CoinChart, { coinId: coin.id }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "coin-details-links", children: [
        coin.links.homepage[0] && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "🌐",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
        ...
        coin.links.blockchain_site[0] && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "🧩",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
        ...
        coin.categories.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "Categories: ",
          coin.categories.join(", ")
        ] })
      ] })
    ] }),
    !loading && !error && !coin && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No Data Found" })
  ] });
};
...
const App = () => {
  ...
  const [sortBy, setSortBy] = reactExports.useState("market_cap_desc");
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/coin/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(CoinDetailsPage, {}) }),
